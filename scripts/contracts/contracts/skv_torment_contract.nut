this.skv_torment_contract <- this.inherit("scripts/contracts/contract", {
	...
	function createScreens()
	{
		...
		this.m.Screens.push({
			...
			Text = "[img]gfx/ui/events/event_97.png[/img]{%employer% is not alone. A girl stands at his elbow, holding a purse so small it hardly bends her fingers.%SPEECH_ON%An ogre came down the high street this morning like he owned it. Took old %SKVNAME%Lazino%SKVNAME_OFF%, our sage, the man who set half the bones in this village and taught the other half their letters. Lifted him by the head like a turnip and dropped him in a grain sack. All the brute said was a name, %SKVNAME%Haanar%SKVNAME_OFF%, and that Haanar wanted words with him. Then off to the hills, laughing the whole way.%SPEECH_OFF%The girl steps forward before he can go on.%SPEECH_ON%I'm %SKVNAME%Leyla%SKVNAME_OFF%. He's my grandfather. This is everything I have. I know it isn't much. Please bring him home.%SPEECH_OFF%%employer% lays a hand on her shoulder.%SPEECH_ON%Haanar is an exile. We drove him out some winters back, after he took to dabbling in things decent folk leave alone. What he wants with an old man, I couldn't tell you. The village will add what it can scrape together to the girl's purse. As for the trail, an ogre does not walk softly.%SPEECH_OFF%}",
			Image = "",
			List = [],
			ShowEmployer = true,
			ShowDifficulty = true,
		...
		this.m.Screens.push({
			...
			Text = "[img]gfx/ui/events/event_42.png[/img]{Nobody could lose this trail. The ogre has left footprints you could bath a child in, and a mile on, what is left of a shaggy hill cow, opened up and given to the crows. By sundown there is firelight on a hilltop ahead, and the wind brings down the smell of beef on the spit. Then a man screaming. Then laughter, deep enough to feel through your boots.%SPEECH_ON%Squeal all you like, grandfather! Squealing's how I know the meat's still fresh!%SPEECH_OFF%%randombrother% squints up the slope.%SPEECH_ON%He's been at a barrel, that one. Listen to him. And he isn't alone. There's shapes round that fire, low ones, squatting.%SPEECH_OFF%The trail climbs straight up through the mud, between boulders. If the whole company keeps quiet, it could reach the fire before anyone up there looks round. It only takes one man's clumsy step to spoil it.}",
			Image = "",
			List = [],
			Options = [],
			function start()
		...
		this.m.Screens.push({
			...
			{
				local c = this.Contract;
				this.Text = "[img]gfx/ui/events/event_154.png[/img]{The ogre goes down like a felled oak and doesn't get up. You cut %SKVNAME%Lazino%SKVNAME_OFF% down from the pole. He's bruised, singed along one sleeve, and furious the way only an old man who's just been called fresh meat can be.%SPEECH_ON%Haanar? I haven't the faintest notion what the boy wants with me. The brute said some stranger paid them for me in coin and cows. Cows! For me!%SPEECH_OFF%Behind the fire a low cave mouth breathes out mushroom rot and worse. The ogre has been living in there, and sleeping on whatever he took off the people he ate.\n\nOnce you head down the far side of this hill, you won't be climbing it again.}";
				this.List = [];
				this.Options = [];
				if (c.m.Searched == 0)
				{
		...
		this.m.Screens.push({
			...
			Text = "[img]gfx/ui/events/event_101.png[/img]{The path down the far side runs through a ring of standing stones, one of them toppled. As you pass between them, they begin to glow a deep emerald. The air fills with the smell of wet leaves, and a young man steps out of the light as though through a doorway.\n\nHe is almost human. His fingers are too long, and one eye is green and the other grey. He's angry to the roots of his teeth. A crystal-headed staff is in his hand and a wolf pads at his heel.%SPEECH_ON%Lazino. You knew what I am. All those years, you knew. Say it.%SPEECH_OFF%The old man goes white. Then, to everyone's surprise, he pushes past your shield line.%SPEECH_ON%Your mother. That's what you've come for, and you'll have it. Twenty years back a stranger stopped at Ragir Grenvill's farm, a handsome woman, and she was gone inside two weeks. Come the next winter there was a basket on his step with you in it. I knew her for a hag the first time I looked in your eyes, and I held my tongue. I thought an honest man's love would be enough to raise you straight. Ragir went to his grave without telling you, and I let him. That's my doing, lad, not yours. Come home with us. There's room.%SPEECH_OFF%The staff dips an inch. The wolf stops growling. Haanar isn't calm, but for the moment he's listening, and he won't listen for long. One of you has to find the right words while he still hears them. If they're the wrong words, he'll fight.}",
			Image = "",
			List = [],
			Options = [],
			function start()
