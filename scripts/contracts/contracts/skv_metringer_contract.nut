this.skv_metringer_contract <- this.inherit("scripts/contracts/contract", {
	...
	function metringerPools()
	{
		return {
			...
			single = ::MSU.Class.WeightedContainer([
				[10, "scripts/items/loot/silver_bowl_item"],
				[10, "scripts/items/loot/ancient_amber_item"],
				[8,  "scripts/items/loot/ornate_tome_item"],
				[8,  "scripts/items/loot/marble_bust_item"],
				[10, "scripts/items/misc/snake_oil_item"],
				[6,  "scripts/items/loot/white_pearls_item"],
				[5,  "scripts/items/loot/ancient_gold_coins_item"],
				[4,  "scripts/items/loot/golden_chalice_item"],
				[2,  "scripts/items/loot/gemstones_item"],
				[1,  "scripts/items/loot/jeweled_crown_item"],
			]),
			mid = [
	...
	function onPrepareVariables( _vars )
	{
		...
		_vars.push(["actor", this.m.ActorName]);
	}
