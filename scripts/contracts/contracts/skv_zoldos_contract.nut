	...
	function createScreens()
	{
		...
		this.m.Screens.push({
			...
			function start()
			{
				...
				local speech = "%SPEECH_ON%Two dozen cattle. That was the price. Twenty-four fat beasts, which is very little to ask of a village whose roofs stay on because I allow it. And they have sent me this: hired swords with mud on their boots.%SPEECH_OFF%He does not get up. He has not needed to get up for anything in years.%SPEECH_ON%Do you know whose hall this is? Men have made songs about Zikritrax. Short songs, mostly. The singers did not last.%SPEECH_OFF%Somewhere back along the line a man shifts his grip and the sound goes all the way up into the dark and comes back.%SPEECH_ON%So. Kneel. Put down everything you brought, every blade and every coin, and perhaps I let you walk home and tell them how gracious I was. Or you can join the mayor's brood in the stone cage. They complain a great deal. They would like the company.%SPEECH_OFF%";
