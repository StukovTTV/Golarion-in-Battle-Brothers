// ============================================================================
//  skv_kobold_dragon_priest -- the dragon-priest (Golarion Localization).
//
//  A thin reskin of legend_goblin_witch_doctor: same art, sounds, AI and equipment
...
// ============================================================================
this.skv_kobold_dragon_priest <- this.inherit("scripts/entity/tactical/enemies/legend_goblin_witch_doctor", {
	m = {},

	function create()
	{
		this.legend_goblin_witch_doctor.create();
		this.m.Type = ::Const.EntityType.SkvKoboldDragonPriest;
